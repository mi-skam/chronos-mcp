...
class TestServerInputValidation:
    ...
    def test_color_validation_enforces_hex_format(self):
        ...
        for color in invalid_colors:
            assert not validator.PATTERNS["color"].match(color), f"Invalid color should be rejected: {color}"
    ...
    def test_url_validation_allows_common_caldav_patterns(self):
        ...
        for url in common_caldav_urls:
            assert validator.PATTERNS["url"].match(url), f"Common CalDAV URL should be allowed: {url}"
