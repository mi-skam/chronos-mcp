...
class TestThreadSafety:
    ...
    def test_concurrent_connection_creation(self, mock_config_with_account):
        ...
        with patch('chronos_mcp.accounts.DAVClient') as mock_dav_client, \
            ...
            assert all(r is not None for r in results), "All threads should have gotten a connection"
            ...
            assert len(connection_attempts) <= 2, f"Too many connection attempts: {len(connection_attempts)}"
