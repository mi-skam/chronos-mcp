...
# Default parameter values for tool functions
DEFAULT_CREATE_TASK_PARAMS = {
    "description": None,
    "due": None,
    "priority": None,
    "status": "NEEDS-ACTION",
...
DEFAULT_LIST_TASKS_PARAMS = {"status_filter": None, "account": None}
...
DEFAULT_DELETE_TASK_PARAMS = {"account": None, "request_id": None}
...
class TestTaskTools:
    ...
    async def test_create_task_priority_type_error(self, setup_managers):
        ...
        result = await create_task(
            calendar_uid="cal-123",
            summary="Test Task",
            priority=None,  # TypeError when int(None)
        )
    ...
    async def test_create_task_summary_validation_error(self, setup_managers):
        ...
        with patch(
            ...
            result = await create_task(
                calendar_uid="cal-123", summary="x" * 1000  # Very long summary
            )
    ...
    async def test_create_task_invalid_status(self, setup_managers):
        ...
        result = await create_task(
            calendar_uid="cal-123", summary="Test Task", status="INVALID-STATUS"
        )
    ...
    async def test_create_task_due_date_none(self, setup_managers, sample_task):
        ...
        result = await create_task(calendar_uid="cal-123", summary="Test Task")
    ...
    async def test_create_task_calendar_not_found_error(self, setup_managers):
        ...
        error = CalendarNotFoundError("Calendar not found", calendar_uid="cal-123")
        ...
        assert result["success"] is False
        assert (
            "calendar_uid" in result["error_code"]
            or "CALENDAR_NOT_FOUND" in result["error_code"]
        )
        assert "request_id" in result
    ...
    async def test_create_task_event_creation_error(self, setup_managers):
        ...
        assert result["success"] is False
        assert result["error_code"] == "EVENT_CREATION_ERROR"
    ...
    async def test_create_task_chronos_error(self, setup_managers):
        ...
        assert result["success"] is False
        assert result["error_code"] == "CHRONOS_ERROR"
    ...
    async def test_list_tasks_success(self, setup_managers, sample_task):
        ...
        result = await list_tasks(calendar_uid="cal-123")
    ...
    async def test_list_tasks_with_status_filter(self, setup_managers, sample_task):
        ...
        result = await list_tasks(calendar_uid="cal-123", status_filter="NEEDS-ACTION")
    ...
    async def test_list_tasks_invalid_status_filter(self, setup_managers):
        ...
        result = await list_tasks(
            calendar_uid="cal-123", status_filter="INVALID-STATUS"
        )
    ...
    async def test_list_tasks_with_account(self, setup_managers, sample_task):
        ...
        result = await list_tasks(calendar_uid="cal-123", account="test_account")
    ...
    async def test_update_task_success(self, setup_managers, sample_task):
        ...
        result = await update_task(
            calendar_uid="cal-123", task_uid="task-123", summary="Updated Summary"
        )
    ...
    async def test_update_task_priority_string_conversion(
        ...
        result = await update_task(
            calendar_uid="cal-123", task_uid="task-123", priority="7"
        )
    ...
    async def test_update_task_invalid_priority_string(self, setup_managers):
        ...
        result = await update_task(
            calendar_uid="cal-123", task_uid="task-123", priority="invalid"
        )
    ...
    async def test_update_task_priority_type_error(self, setup_managers):
        ...
        # Using a complex object that would cause TypeError
        result = await update_task(
            calendar_uid="cal-123",
            task_uid="task-123",
    ...
    async def test_update_task_percent_complete_string_conversion(
        ...
        result = await update_task(
            calendar_uid="cal-123", task_uid="task-123", percent_complete="50"
        )
    ...
    async def test_update_task_invalid_percent_complete_string(self, setup_managers):
        ...
        result = await update_task(
            calendar_uid="cal-123", task_uid="task-123", percent_complete="invalid"
        )
    ...
    async def test_update_task_summary_validation_error(self, setup_managers):
        ...
        with patch(
            ...
            result = await update_task(
                calendar_uid="cal-123", task_uid="task-123", summary="Invalid summary"
            )
    ...
    async def test_update_task_invalid_status(self, setup_managers):
        ...
        result = await update_task(
            calendar_uid="cal-123", task_uid="task-123", status="INVALID-STATUS"
        )
    ...
    async def test_update_task_due_none_in_response(self, setup_managers):
        ...
        result = await update_task(
            calendar_uid="cal-123", task_uid="task-123", summary="Updated"
        )
    ...
    async def test_delete_task_success(self, setup_managers):
        ...
        result = await delete_task(calendar_uid="cal-123", task_uid="task-123")
    ...
    async def test_delete_task_with_account(self, setup_managers):
        ...
        result = await delete_task(
            calendar_uid="cal-123", task_uid="task-123", account="test_account"
        )
    ...
    async def test_create_task_empty_summary(self, setup_managers):
        ...
        with patch(
            ...
            result = await create_task(calendar_uid="cal-123", summary="")
    ...
    async def test_create_task_malformed_due_date(self, setup_managers):
        """Test create_task with malformed due date"""
        with patch("chronos_mcp.tools.tasks.parse_datetime") as mock_parse:
            mock_parse.side_effect = ValueError("Invalid date format")

            result = await create_task(
                calendar_uid="cal-123", summary="Test Task", due="invalid-date"
            )

            assert result["success"] is False
            # Should be caught as an unexpected exception

    @pytest.mark.asyncio
    async def test_update_task_malformed_due_date(self, setup_managers):
        """Test update_task with malformed due date"""
        with patch("chronos_mcp.tools.tasks.parse_datetime") as mock_parse:
            mock_parse.side_effect = ValueError("Invalid date format")

            result = await update_task(
                calendar_uid="cal-123", task_uid="task-123", due="invalid-date"
            )
    ...
    async def test_create_task_zero_priority(self, setup_managers):
        ...
        result = await create_task(
            calendar_uid="cal-123", summary="Test Task", priority=0  # Below valid range
        )
    ...
    async def test_managers_not_initialized(self):
        ...
        with pytest.raises(KeyError):
            await create_task(calendar_uid="cal-123", summary="Test Task")
