...
from chronos_mcp.bulk import (
    BulkOperationManager, BulkOptions, BulkOperationMode, 
...
class TestBulkOperationManager:
    ...
    def test_validate_events_missing_fields(self):
        ...
        invalid_events = [
            ...
            {'dtstart': '2025-07-10T10:00:00', 'dtend': '2025-07-10T11:00:00'},  # Missing summary
            {
        ...
        assert len(errors) == 4  # 2 errors for first, 1 for second, 1 for third
