...
async def test_new_features():
    ...
    print(
        '       recurrence_rule="FREQ=WEEKLY;BYDAY=MO;COUNT=52",  # Every Monday for a year'
    )
    ...
    print(
        '       description="Review project progress, discuss blockers, plan next sprint",'
    )
    print('       location="https://zoom.us/j/123456789",')
    print(
        '       recurrence_rule="FREQ=MONTHLY;BYDAY=-1FR;COUNT=12",  # Last Friday of each month'
    )
