...
class BulkOperationManager:
    ...
    def bulk_create_events(self, 
                          ...
                          account_alias: Optional[str] = None) -> BulkResult:
                ...
                for op_result in batch_results:
                    ...
                    if op_result.success:
                        ...
                        if options.mode == BulkOperationMode.FAIL_FAST:
                            ...
                            self._rollback_created_journals(
                                calendar_uid, created_uids
                            )
                            result.successful = 0
    ...
    def _execute_batch_create(self, calendar_uid: str, batch: List[Dict], 
                             start_idx: int, options: BulkOptions,
                             account_alias: Optional[str] = None) -> List[OperationResult]:
    ...
    def _execute_batch_create_tasks(self, calendar_uid: str, batch: List[Dict], 
                                   start_idx: int, options: BulkOptions,
                                   account_alias: Optional[str] = None) -> List[OperationResult]:
    ...
    def _execute_batch_create_journals(self, calendar_uid: str, batch: List[Dict], 
                                      start_idx: int, options: BulkOptions,
                                      account_alias: Optional[str] = None) -> List[OperationResult]:
